...
```{r Comparativa_por_marcas_grafico}
...
# Agrupamos los datos por Tipo de Combustible
...
# Mostrar Tabla de Combustible
print(fuel_qpr_summary)

# Preparación y Gráfico de Combustible
...
geom_bar(stat = "identity", color = "black", width = 0.7) +
geom_text(aes(label = sprintf("%.2f", QPR_Promedio)), hjust = -0.1, size = 4, fontface = "bold") +
labs(title = "Relación Calidad-Precio (QPR) Promedio por Tipo de Combustible",
